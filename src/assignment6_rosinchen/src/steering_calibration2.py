...
a_180 = np.array([[30.5,21.7],[34,39.2],[61.9,55]])/100
a_150 = np.array([[19.3,17.8],[70,33.6],[60,68.9]])/100
a_120 = np.array([[19.6,18.1],[33.8,35.2],[53.2,54.3]])/100
a_90 = np.array([[20.8,18.1],[34.3,32.0],[55.5,55.8]])/100
a_60 = np.array([[26.8,26.2],[52.6,38.0],[72.7,51.0]])/100
a_30 = np.array([[25.4,22.4],[44.6,30.5],[62.3,41.0]])/100
a_0 = np.array([[26.2,20.2],[39.8,24.1],[62.7,39.9]])/100
...
daten = np.array([lenkwinkel(a_180)[2],lenkwinkel(a_150)[2],lenkwinkel(a_120)[2],lenkwinkel(a_90)[2],lenkwinkel(a_60)[2],lenkwinkel(a_30)[2],lenkwinkel(a_0)[2]])

print(daten)

print(lenkwinkel(a_180))
print(lenkwinkel(a_150))
print(lenkwinkel(a_120))
print(lenkwinkel(a_90))
print(lenkwinkel(a_60))
print(lenkwinkel(a_30))
print(lenkwinkel(a_0))
